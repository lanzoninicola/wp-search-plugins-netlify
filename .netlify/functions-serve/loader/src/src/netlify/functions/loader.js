  ...
  "node_modules/@supabase/realtime-js/dist/main/RealtimeChannel.js"(exports) {
    ...
    var RealtimeChannel = class {
      ...
      trigger(type, payload, ref) {
        ...
        this.bindings.filter((bind) => {
          var _a4, _b;
          return (bind === null || bind === void 0 ? void 0 : bind.type) === type && (((_a4 = bind === null || bind === void 0 ? void 0 : bind.filter) === null || _a4 === void 0 ? void 0 : _a4.event) === "*" || ((_b = bind === null || bind === void 0 ? void 0 : bind.filter) === null || _b === void 0 ? void 0 : _b.event) === (payload === null || payload === void 0 ? void 0 : payload.event));
        }).map((bind) => bind.callback(handledPayload, ref));
      }
      send(payload) {
  ...
  "node_modules/@supabase/realtime-js/dist/main/RealtimeClient.js"(exports) {
    ...
    var RealtimeClient = class {
      ...
      channel(topic, chanParams = {}) {
        ...
        const chan = ((_a4 = this.params) === null || _a4 === void 0 ? void 0 : _a4.vsndate) ? new RealtimeChannel_1.default(topic, params, this) : new RealtimeSubscription_1.default(topic, params, this);
...
var require_SupabaseClient = __commonJS({
  "node_modules/@supabase/supabase-js/dist/main/SupabaseClient.js"(exports) {
    ...
    var SupabaseClient = class {
      ...
      channel(name, opts) {
        var _a4, _b;
        const userToken = (_b = (_a4 = this.auth.session()) === null || _a4 === void 0 ? void 0 : _a4.access_token) !== null && _b !== void 0 ? _b : this.supabaseKey;
      ...
      _initSupabaseAuthClient({ autoRefreshToken, persistSession, detectSessionInUrl, localStorage, headers, fetch: fetch3, cookieOptions, multiTab }) {
        const authHeaders = {
...
// src/netlify/functions/loader.ts
var loader_exports = {};
...
// src/services/wp-plugins-api-service.ts
var WordpressPluginsAPIService = class {
  constructor() {
    this.baseURL = "https://api.wordpress.org/plugins/info/1.2/";
    this.wpAction = "query_plugins";
  }
  async findPaginated({
    page = 1,
    perPage = 250
    ...
    try {
      const response = await fetch2(fullURL, options);
...
var SupabaseService = class {
  ...
  async addBulk(plugins) {
    const { error } = await supabase_server_default.from("plugins_raw").insert(plugins);
    console.log(error);
    if (error) {
      return {
        ok: false,
